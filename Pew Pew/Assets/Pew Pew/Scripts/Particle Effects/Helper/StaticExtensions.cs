...
/// </summary>
	public static class StaticExtensions
	{
		...
		public static class Color
		{
			...
			public static UnityEngine.Color HSVToColor(float h, float s, float v)
			{
				if (h == 0 && s == 0)
					return new UnityEngine.Color(v, v, v);
				...
				if (h < 1) return new UnityEngine.Color(c + m, x + m, m);
				else if (h < 2) return new UnityEngine.Color(x + m, c + m, m);
				else if (h < 3) return new UnityEngine.Color(m, c + m, x + m);
				else if (h < 4) return new UnityEngine.Color(m, x + m, c + m);
				else if (h < 5) return new UnityEngine.Color(x + m, m, c + m);
				else return new UnityEngine.Color(c + m, m, x + m);
			}
		}
